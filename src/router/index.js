    ...
    children: [
      ...
      // Product-specific legal/help pages (public)
      {
        ...
        meta: {
          ...
          seoTitle: 'NoteFormat — Smart Note & Expense Tracker for iOS',
          seoDescription: 'NoteFormat – Your Smart Note & Expense Companion. Capture expenses, format with templates, import/export easily. Track spending, budgets, and reports. Free on the App Store with iCloud sync and Game Center.',
          seoKeywords: 'NoteFormat, iOS app, expense tracker, note taking, budget tracker, spending tracker, iCloud sync, CSV export, Siri shortcuts, Game Center, personal finance app, free iOS app',
